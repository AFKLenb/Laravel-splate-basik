...
@section('title') {{__('О нас')}}@endsection
@section('content')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <img src="{{asset('/assets/images/cleaning-concept-with-man-showing-business-card.jpg')}}" class="featured-image img-fluid">
                </div>
                ...
                <div class="col-lg-6 col-12">
                    <div class="featured-block">
                        ...
                        <a class="custom-btn btn button button--atlas mt-3" href="contact">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-lg-0 mb-md-5">
                    <img src="{{asset('/assets/images/teams/young-cleaning-man-wearing-casual-clothes.jpg')}}" class="team-image img-fluid">
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <img src="{{asset('/assets/images/teams/happy-young-woman-wiping-kitchen-counter-wearing-yellow-gloves.jpg')}}" class="team-image img-fluid">
                </div>
